	...
	// start root
	{
		...
		// start root.CharacterControl
		{
			...
			// start root.CharacterControl.Events
			{
				...
				SoldierNPCAnimSM_Event_STOP_SHOOT::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
				...
				//SoldierNPCMovementSM_Event_STOP_SHOOT::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
