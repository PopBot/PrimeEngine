-- this is game object script for a TargetNPC object of CharacterControl demo
-- this script will be executed whenever a TargetNPC is added to the game
...
outputDebugString("Executing TargetNPC.lua")
